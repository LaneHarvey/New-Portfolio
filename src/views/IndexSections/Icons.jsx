        ...
        <section className="section section-lg section-nucleo-icons">
          <Container>
            ...
            <div className="icons-container blur-item mt-5 on-screen">
              ...
              <i className="icon icon-sm" id="tooltip24602">
                <span
                  className="iconify"
                  data-icon="mdi:dot-net"
                  data-inline="false"
                ></span>
              ...
              <i className="icon icon-sm ni " id="tooltip24603">
                <span
                  className="iconify"
              ...
              <i className="icon icon-sm ni " id="tooltip24604">
                <span
                  className="iconify"
              ...
              <i className="icon icon-sm " id="tooltip24605">
                <span
                  className="icon icon-sm iconify"
                  data-icon="raphael:db"
                  data-inline="false"
                ></span>
              ...
              <i className="icon ni " id="tooltip24606">
                <span
                  className="iconify"
              ...
              <i className="icon ni " id="tooltip24607">
                <span
                  className="iconify"
              ...
              <i className="icon ni" id="tooltip24608">
                <span
                  className="iconify"
              ...
              <i className="icon ni " id="tooltip24609">
                <span
                  className="iconify"
                  data-icon="mdi:visual-studio"
                  data-inline="false"
                ></span>
              ...
              <i className="icon " id="tooltip246010">
                <span
                  className="iconify"
                  data-icon="fa-brands:php"
                  data-inline="false"
                ></span>
              ...
              <i className="icon " id="tooltip246011">
                <span
                  className="iconify"
                  data-icon="simple-icons:angular"
                  data-inline="false"
                ></span>
              ...
              <i className="icon ni " id="tooltip246012">
                <span
                  className="iconify"
              ...
              <i className="icon ni" id="tooltip246013">
                <span
                  className="iconify"
              ...
              <i className="icon fa fa-html5" id="tooltip246014">
